...
# added DataBase before th final /
engine = create_engine("sqlite:///ANN/DataBase/AllBrainsDB.db", echo=False)

meta = MetaData()


class AllBrainsTable(Base):
    """Base table creation"""
...
def save_all_brain_instance(brain: BrainInstance):
